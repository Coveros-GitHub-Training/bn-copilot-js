...
**Note**: Different from Cloud Agent (which works on GitHub.com)
...
~~### Custom Chat Modes~~
### Custom Agents
Autonomous AI assistants with specialized instructions and capabilities that can be used in the IDE, CLI, or with Cloud Agent.
...
**Scope**: IDE, CLI, and Cloud Agent  
**Examples**: C# Expert agent, Testing agent, Security agent

---

## Cloud Agent & Autonomous Development

### Cloud Agent (GitHub Copilot Cloud Agent or CCA)
...
### Session Logs
Detailed records of Cloud Agent's decision-making process, showing what files were analyzed, what approaches were considered, and why specific decisions were made.
...
### Session Steering
The ability to guide Cloud Agent mid-session by adding prompts to influence its approach while it's working.
...
**Purpose**: Clear success metrics for Cloud Agent
...
- **Use**: Available in agent selector when using Agent mode or when assigning work to Cloud Agent
...
| Feature | IDE Agent Mode | Cloud Agent | Custom Agents |
|---------|----------------|--------------|---------------|
...
**Last Updated**: Reference for GitHub Copilot Workshop  
