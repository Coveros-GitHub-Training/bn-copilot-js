...
Now comes the **key insight** about Cloud Agent: you don't sit and wait! While CCA works autonomously on the profile page, you'll be productive on a completely different task.

Let's build a social sharing feature using **Copilot Agent mode in VS Code** while Cloud Agent works in parallel on GitHub.
...
**Now for the magic**: While you were working on this feature in your IDE, Cloud Agent has been autonomously building the profile page on GitHub! Let's check on its progress.

### 💡 What Just Happened?

You experienced **true parallel development**:
- ✅ Cloud Agent worked on the profile page (GitHub)
...
Now let's see what Cloud Agent has accomplished while you were working on the social sharing feature!
...
```
9:00 AM  - You assigned profile page to Cloud Agent
9:02 AM  - You started building social sharing in IDE
9:30 AM  - You finished social sharing (with Copilot's help debugging)
9:35 AM  - You reviewed Cloud Agent's completed profile page PR

Results:
✅ Profile page: COMPLETE (built by Cloud Agent)
...
**Documentation**: [VS Code Integration](https://docs.github.com/copilot/how-tos/use-copilot-agents/cloud-agent/create-a-pr#asking-copilot-to-create-a-pull-request-from-copilot-chat-in-visual-studio-code)
...
> [!IMPORTANT]
> Just because you can delegate several tasks to Copilot Cloud Agent at the same time does not mean you always should or need to. Like with all things moderation is key. Strive to ensure that the tasks you give to CCA are the best fit for it and aren't more than you can handle. While the following are a good baseline on how to decide what tasks are best for Copilot Cloud Agent you will need to use your judgement on a case by case basis so you can get the maximum benefit of these tools!
...
### Learn More
- Explore [Official Cloud Agent Documentation](https://docs.github.com/copilot/how-tos/use-copilot-agents/cloud-agent)
